...
assert(GetRawMT and HookFunction and GetNCMethod and CheckCaller and Connections, "Exploit is not supported");
...
expro.protect_instance = function(NewInstance)
    table.insert(ProtectedInstances, NewInstance)
end

expro.unprotect_instance = function(NewInstance)
